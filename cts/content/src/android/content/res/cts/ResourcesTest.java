...
public class ResourcesTest extends AndroidTestCase {
    ...
    public void testGetDrawable() {
        ...
        Log.d("======>","targetDensity, defaultDensity " + targetDensity + ", " + defaultDensity);
        assertNotNull(draw);
        int val1 = 212 * targetDensity / defaultDensity;
        int val2 = draw.getIntrinsicWidth();
        Log.d("=====>", "width   val1 " + val1 + ", val2 " + val2);
        assertEquals(212 * targetDensity / defaultDensity, draw.getIntrinsicWidth(), 1);
        val1 = 142 * targetDensity / defaultDensity;
        val2 = draw.getIntrinsicHeight();
        Log.d("=====>", "height   val1 " + val1 + ", val2 " + val2);
