...
int32_t NX_GTDeintDoDeinterlace(NX_GT_DEINT_HANDLE handle, NX_VID_MEMORY_INFO *pInBuf, NX_VID_MEMORY_INFO *pOutBuf )
{
	...
	NX_GTServiceCommand( gstService, GT_SERVICE_ID_DEINTERLACE, GT_SERVICE_CMD_DO, &paramDo );
	return 0;
}
...
int32_t NX_GTSclDoScale(NX_GT_SCALER_HANDLE handle, NX_VID_MEMORY_INFO *pInBuf, NX_VID_MEMORY_INFO *pOutBuf )
{
	...
	paramDo.pInBuf	= pInBuf;
	paramDo.pOutBuf	= pOutBuf;
	NX_GTServiceCommand( gstService, GT_SERVICE_ID_SCALER, GT_SERVICE_CMD_DO, &paramDo );
	return 0;
}
...
int32_t NX_GTRgb2YuvDoConvert( NX_GT_RGB2YUV_HANDLE handle, int inputIonFd, NX_VID_MEMORY_INFO *pOutBuf )
{
	...
	paramDo.pOutBuf	= pOutBuf;
	NX_GTServiceCommand( gstService, CT_SERVICE_ID_RGB2YUV, GT_SERVICE_CMD_DO, &paramDo );
	return 0;
}
...
int32_t NX_GTYuv2RgbDoConvert( NX_GT_YUV2RGB_HANDLE handle, NX_VID_MEMORY_INFO *pOutBuf, int inMemIonFd )
{
	NX_GT_PARAM_DO paramDo;
	paramDo.handle = handle;
	paramDo.pInBuf	= pOutBuf;
	paramDo.pOutBuf	= (void*)inMemIonFd;
	NX_GTServiceCommand( gstService, CT_SERVICE_ID_YUV2RGB, GT_SERVICE_CMD_DO, &paramDo );
	return 0;
}
